<template>
    <div class="m-input">
        <template v-if="regex == 'mobile'">
            <input type="tel" pattern="[0-9]*" v-model="currentValue" :name="name" @focus="showClear = true" @blur="blurHandler" maxlength="11" :placeholder="placeholder" :autocomplete="autocomplete" :readonly="readonly" :disabled="disabled">
        </template>
        <template v-else>
            ...
            <input v-if="type == 'time'" type="time" v-model="currentValue" :name="name" @focus="showClear = true" @blur="blurHandler" :maxlength="max" :placeholder="placeholder" :autocomplete="autocomplete" :readonly="readonly" :disabled="disabled">
        </template>
...
export default {
    ...
    watch: {
        value(val) {
            // debugger
            if (this.type === "number" && this.max && val.length > this.max) {
    ...
    methods: {
        ...
        trim(str, char) {
            if (!!str) {
                // console.log(str.replace(new RegExp('^\\' + char + '+|\\' + char + '+$', 'g'), ''))
